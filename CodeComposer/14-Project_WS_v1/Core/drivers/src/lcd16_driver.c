...
void Lcd_Print_Char_Line(const char letter, LCD_LINE line, int offset)
{
    switch (line) {
    case LCD_LINE_1:
...
void Lcd_Print_Line(const char *message, LCD_LINE line, int offset)
{
    switch (line) {
    case LCD_LINE_1:
...
{
    Lcd_Print_Line(data_line1, LCD_LINE_1, 0);
    Lcd_Print_Line(data_line2, LCD_LINE_2, 0);
}
